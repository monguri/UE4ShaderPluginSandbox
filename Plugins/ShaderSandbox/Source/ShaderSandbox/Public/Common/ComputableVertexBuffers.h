...
struct FComputableVertexBuffers
{
	...
	virtual void InitFromDynamicVertex(class FLocalVertexFactory* VertexFactory, TArray<struct FDynamicMeshVertex>& Vertices, uint32 NumTexCoords = 1, uint32 LightMapIndex = 0);
};
